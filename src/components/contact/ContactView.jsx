...
export default function ContactView({ siteConfig = defaultSiteConfig }) {
  const cfg = siteConfig || defaultSiteConfig;
        ...
        <div className="container relative z-10">
          ...
          <ScrollReveal direction="up" delay={0.35}>
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 pt-1">
              <a
                href={`tel:${cfg.contact?.phoneRaw || '+919820123456'}`}
              ...
              >
                <Mail size={15} className="text-ofs-red-400 shrink-0" /> {cfg.contact?.email}
              </a>
              <a
                href="#rfq-form"
              ...
              <ScrollReveal direction="left" delay={0.1}>
                ...
                <div className="bg-ofs-navy-50/50 border border-ofs-navy-100 rounded-lg p-5 sm:p-7 lg:p-9 mb-6 shadow-sm">
                  ...
                  <p className="text-[0.925rem] text-ofs-gray-700 leading-relaxed mb-4">
                    {cfg.contact?.addressUSA?.line1}, {cfg.contact?.addressUSA?.city}, {cfg.contact?.addressUSA?.state}, {cfg.contact?.addressUSA?.pincode}, {cfg.contact?.addressUSA?.country}
                  </p>
                ...
                <div className="bg-ofs-navy-50/50 border border-ofs-navy-100 rounded-lg p-5 sm:p-7 lg:p-9 mb-8 shadow-sm">
                  ...
                  <p className="text-[0.925rem] text-ofs-gray-700 leading-relaxed mb-4">
                    {cfg.contact?.addressIndia?.line1}, {cfg.contact?.addressIndia?.line2}, {cfg.contact?.addressIndia?.city}, {cfg.contact?.addressIndia?.state} – {cfg.contact?.addressIndia?.pincode}, {cfg.contact?.addressIndia?.country}
                  </p>
                  <div className="flex flex-col gap-2 text-sm text-ofs-navy-950 font-mono pt-3 border-t border-ofs-navy-100">
