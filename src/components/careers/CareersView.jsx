...
import defaultJobsData from '@/data/jobs.json';
...
export default function CareersView({ jobs = defaultJobsData }) {
  const jobsList = jobs && jobs.length > 0 ? jobs : defaultJobsData;
        ...
        <div className="container relative z-10">
          ...
          <ScrollReveal direction="up" delay={0.35}>
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 pt-2">
              ...
              >
                <Briefcase size={16} /> Explore {jobsList.length} Open Positions ↓
              </a>
        ...
        <div className="container">
          ...
          <div id="open-positions" className="max-w-[820px] mx-auto pt-4 scroll-mt-24">
            <div className="text-center mb-10">
              ...
              <h2 className="section-title">
                <TextReveal tag="span" duration={0.65}>
                  Open Career Roles ({jobsList.length})
                </TextReveal>
              </h2>
            </div>
            ...
            <div className="flex flex-col gap-4">
              {jobsList.map((job, idx) => (
                <ScrollReveal key={job.id || idx} direction="up" delay={idx * 0.08}>
                  <Link
