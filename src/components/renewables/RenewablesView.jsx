  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 selection:bg-emerald-500 selection:text-white overflow-x-hidden">
                  ...
                  >
                    ...
                    <div className="p-5 sm:p-6 flex flex-col flex-1">
                      ...
                      <div className="mt-4 sm:mt-5 pt-3.5 sm:pt-4 border-t border-slate-100">
                        <span
                          className="text-emerald-600 text-[0.75rem] sm:text-[0.8rem] font-semibold
      ...
      {/* ═══════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-white" aria-label="Why OFS Renewables">
        <div className="container max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="container relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-4 sm:gap-x-5 gap-y-8 sm:gap-y-10">
            {(data.approachSteps || []).map((stepItem, idx) => {
              const IconComponent = iconMap[stepItem.icon] || FileText;
              const isLast = idx === (data.approachSteps || []).length - 1;
              return (
                <ScrollReveal key={stepItem.step || idx} direction="up" delay={idx * 0.05}>
      ...
      {/* ═══════════════════════════════════════════════════════════
          5 · PARTNER WITH US
          ═══════════════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-white" aria-label="Partner With Us">
        <div className="container max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          {/* Header */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 lg:gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4 lg:gap-5">
              {(data.partnerCards || []).map((card, idx) => {
                  ...
                  <ScrollReveal key={idx} direction="up" delay={idx * 0.06}>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h3
                          className="text-[0.85rem] sm:text-[0.92rem] font-bold text-[#0c1e4e] mb-1 sm:mb-1.5 leading-snug
                      ...
                      <ArrowUpRight
                        size={15}
                        className="text-slate-300 group-hover:text-emerald-500 shrink-0 mt-0.5 transition-colors duration-200"
                        aria-hidden="true"
                      />
                    </Link>
                  </ScrollReveal>
      ...
      >
        <div
          ...
          style={{ backgroundImage: `url('${data.ctaBgImage || data.partnerBgImage || defaultRenewablesData.heroBgImage}')` }}
          role="img"
        ...
        <div className="container relative z-10 max-w-3xl lg:max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollReveal direction="up" delay={0.15}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <a
                href={`mailto:${data.contactEmail || defaultRenewablesData.contactEmail}`}
              ...
              >
                ...
                {data.contactEmail || defaultRenewablesData.contactEmail}
              </a>
            </div>
          </ScrollReveal>
        </div>
