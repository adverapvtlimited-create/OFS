...
export default function Hero({ siteConfig: passedConfig }) {
  const siteConfig = passedConfig || localSiteConfig;
  const heroImageUrl = getStrapiMedia(siteConfig.heroImage) || '/images/live/Banner3.jpg';
